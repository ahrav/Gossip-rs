...
///   coordinator at execution time via [`validate_split_coverage`](super::shard_spec::validate_split_coverage).
///
...
/// at execution time via [`validate_residual_split`](super::shard_spec::validate_residual_split),
