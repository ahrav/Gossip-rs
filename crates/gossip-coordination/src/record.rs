...
//! - [`crate::error::ShardSnapshotView`] — worker-visible
//!   read-only view returned on acquisition
//!
//! ## Ownership Model
//!
//! `ShardRecord` fields are `pub` rather than private because the
...
/// ## Visibility
///
/// Fields are `pub` — the coordinator backend directly mutates
