...
use crate::Lease;
use gossip_contracts::identity::{OpId, RunId, ShardId, ShardKey, WorkerId};
...
pub const OP_ID_PARTITION: u64 = 1_000_000;
...
mod tests {
    ...
    fn dummy_lease(worker: WorkerId, key: &ShardKey) -> Lease {
        use crate::Lease;
        use gossip_contracts::identity::{FenceEpoch, LogicalTime, TenantId};
