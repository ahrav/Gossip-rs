...
use gossip_contracts::coordination::shard_spec::{ShardSpecRef, SplitValidationError};
#[cfg(test)]
...
use gossip_coordination::{
    ...
    ShardId, ShardKey, ShardRecord, ShardStatus, ShardSummary, SplitChildIds,
    SplitReplaceError, SplitReplacePlan, SplitReplaceResult,
    SplitResidualError, SplitResidualPlan, SplitResidualResult, TenantId, UnparkError, WorkerId,
    check_op_idempotency, default_claim_next_available, derive_split_shard_id,
    hash_checkpoint_payload, hash_register_shards_payload, hash_split_replace_payload,
    hash_split_residual_payload, split_replace_apply_parent, split_replace_validate_preconditions,
