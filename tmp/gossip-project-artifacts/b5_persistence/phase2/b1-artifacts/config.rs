...
/// delegate used during the B0/B1 scaffold.
///
/// This is intentionally internal scaffolding. Once the etcd backend stops
/// delegating protocol semantics to `InMemoryCoordinator`, this constant goes
/// away with the bootstrap delegate.
...
impl EtcdCoordinatorConfig {
    ...
    /// Root namespace for all keys produced by [`crate::EtcdKeyspace`].
    #[must_use]
