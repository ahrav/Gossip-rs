...
//! - test-only read-side probe for observing replay/idempotency in findings
//! - reusable smoke tests for reference backends
//!
...
pub use conformance::{
    run_conformance, run_done_ledger_conformance, run_findings_conformance,
    run_redaction_conformance, DurableFindingsCounts, FindingsConformanceProbe,
    PersistenceConformanceError, PersistenceConformanceReport,
};
