...
//!   `gossip-coordination`.
//! - **Connector boundary** — shared paging vocabulary plus family-specific
//!   source contracts (ordered content, Git repo discovery, Git repo execution).
...
// Connector boundary: shared paging vocabulary plus family-specific source
// contracts. (Module-level docs with intra-doc links live in `connector/mod.rs`.)
pub mod connector;
