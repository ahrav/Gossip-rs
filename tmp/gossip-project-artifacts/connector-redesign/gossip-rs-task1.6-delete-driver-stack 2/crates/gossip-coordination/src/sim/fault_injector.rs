...
//! ([`CoordinationBackend`](crate::traits::CoordinationBackend)).
...
use gossip_contracts::identity::{ShardKey, TenantId};
...
mod tests {
    ...
    use gossip_contracts::identity::{FenceEpoch, LogicalTime, RunId, ShardId, WorkerId};
