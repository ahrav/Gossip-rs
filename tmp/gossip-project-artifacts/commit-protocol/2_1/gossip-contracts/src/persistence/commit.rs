...
/// Durable acknowledgement for a family-specific frontier checkpoint.
///
...
///
/// Holding a `PageCommitReceipt` is sufficient proof that the checkpoint
/// boundary can be safely advanced — no further persistence work is required for this page.
#[derive(Clone, Debug, PartialEq, Eq)]
