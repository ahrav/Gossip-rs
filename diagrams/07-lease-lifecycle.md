...
| `crates/gossip-coordination/src/lease.rs` | `Lease`, `ShardLease`, and `LeaseHolder` types |
...
| `crates/gossip-coordination/src/error.rs` | `CapacityHint`, `AcquireResult`, `RenewResult` types |
