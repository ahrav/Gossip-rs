...
See also: [04-end-to-end-scan-flow.md](./04-end-to-end-scan-flow.md) for the full 12-step scan sequence, [05-shard-and-run-state-machines.md](./05-shard-and-run-state-machines.md) for shard assignment lifecycle.
