...
| Mirror lifecycle | Mirror location and refresh behavior are deterministic per repo target. | Reassignment and replay need a stable local execution surface. | Shared mirror pools, eviction policy, and provider-specific mirror orchestration. |
