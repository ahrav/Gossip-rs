...
| **RuleSpec**        | `crates/scanner-engine/src/api.rs:596`               | Rule definitions and specification for rule-based scanning           |
...
| **TransformConfig** | `crates/scanner-engine/src/api.rs:132`               | Transform stage configuration (URL percent, Base64)                  |
...
| **AtomicSeenSets** | `crates/gossip-stdx/src/atomic_seen_sets.rs` | Lock-free bitmap pair (trees + blobs) sized to MIDX object count for parallel dedup |
