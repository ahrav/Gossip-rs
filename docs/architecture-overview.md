...
| **Connector Contracts**            | `crates/gossip-contracts/src/connector/`                                  | `ConnectorCapabilities`, `ErrorClass`, `EnumerateError`, `ReadError`, `ItemKey`, `ScanItem`, `EnumerationPage`, `Budgets`        |
